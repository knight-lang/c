...
enum kn_opcode {
	...
	KN_OPCODE_POP_AND_RET   = KN_NEW_OPCODE(0, 1, 1),

	KN_OPCODE_JMP = KN_NEW_OPCODE(0, 1, 2),
	KN_OPCODE_JEQ = KN_NEW_OPCODE(1, 1, 0),
	KN_OPCODE_JNE = KN_NEW_OPCODE(1, 1, 1),

	KN_OPCODE_PROMPT = KN_NEW_OPCODE(0, 0, 0),
	KN_OPCODE_RANDOM = KN_NEW_OPCODE(0, 0, 1),
