 ...
 **/
kn_hash_int kn_hash_acc(const char *KN_NONNULL str, size_t length, kn_hash_int hash);
 ...
 **/
static inline kn_hash_int kn_hash(const char *KN_NONNULL str, size_t length) {
