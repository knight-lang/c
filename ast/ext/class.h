...
#define MAX_NPARENTS 65535

struct class {
	const char *name;

	unsigned short nfields, nmethods, nstatics, nparents;
	...
	union {
		kn_value *uneval_parents;
		struct class **parents;
	};
	char ran;
};
...
struct function *fetch_method(const struct class *, const char *);
